...
theta2 = zeros(3, 1);
[theta2, J_history2] = gradientDescentMulti(X, y, theta2, 0.3, num_iters);
theta3 = zeros(3, 1);
[theta3, J_history3] = gradientDescentMulti(X, y, theta3, 0.1, num_iters);
theta4 = zeros(3, 1);
[theta4, J_history4] = gradientDescentMulti(X, y, theta4, 0.03, num_iters);
...
plot(1:numel(J_history4), J_history4, '-p', 'LineWidth', 2);
legend('alpha = 0,01', 'alpha = 0.3', 'alpha = 0.1', 'alpha = 0.03')
